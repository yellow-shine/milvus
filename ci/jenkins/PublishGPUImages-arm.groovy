...
pipeline {
    ...
    stages {
        stage('Publish Milvus GPU Images in arm'){
            ...
            steps {
              script {
                  ...
                  PLATFORM_ARCH="arm64"  ./build/builder_gpu.sh /bin/bash -c \"make gpu-install\"
                  """
                  ...
                  withCredentials([usernamePassword(credentialsId: "${env.DOCKER_CREDENTIALS_ID}", usernameVariable: 'DOCKER_USERNAME', passwordVariable: 'DOCKER_PASSWORD')]) {
                      ...
                      sh """
                          ...
                          export MILVUS_IMAGE_TAG="${env.BRANCH_NAME}-${date}-${gitShortCommit}-arm64-gpu"
                          BUILD_ARGS="--build-arg TARGETARCH=arm64" build/build_image_gpu.sh
